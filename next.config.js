	...
	env: {
		...
		**********************************************************************/
		WEB_SOCKET_URL: {
			...
			137: process.env.WS_URL_POLYGON || 'https://rpc.maticvigil.com/',
			56: process.env.WS_URL_BSC|| 'https://testnet.bscscan.com',
			43114: process.env.WS_URL_AVALANCHE || 'https://testnet.snowtrace.io/'
		},
		JSON_RPC_URL: {
			...
			137:  process.env.RPC_URL_POLYGON || 'https://rpc-mumbai.maticvigil.com',
